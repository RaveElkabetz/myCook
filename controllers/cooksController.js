...
exports.getAllCooks = (req, res) => { //the version is for branching out from the current version from the current version without braking v1 for others that use v1
    res.status(200).json(
        {
            status: 'success',
